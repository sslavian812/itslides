...
% \section{Дискретные источники сообщений}
% \section{Измерение информации. Собственная информация.}
% \section{Энтропия}
% \section{Выпуклые функции многих переменных}
% \section{Условная энтропия}
% \section{Дискретные случайные последовательности. Цепи Маркова}
% \section{Энтропия на сообщение дискретного стационарного источника}
% \section{Равномерное кодирование дискретного источника. Постановка задачи }
% \section{Неравенство Чебышева. Закон больших чисел}
% \section{Прямая теорема кодирования для дискретного постоянного
% источника}
% \section{Обратная теорема кодирования для дискретного постоянного
% источника}
% \section[ Множество типичных последовательностей]{Множество типичных последовательностей для дискретного
% постоянного источника. Источники с памятью}
