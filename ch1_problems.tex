...
\begin{enumerate}
  ...
  \emph{Relative entropy of Kullback–Leibler} of distribution $\{p(x), x\in X\}$ according to distribution $\{q(x), x\in X\}$ is the following function: 
    ...
    \end{equation}
    This function should be considered as the measure of difference of two distributions. Indeed, the relative entropy is equal to zero, if this two distributions are equal, and is strictly positive if they differ. Prove the latter statement.
